    ...
    return (
        ...
        <Row id="contact">
            ...
            <div className="d-flex justify-content-center">
                <a className="no-decoration" target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/kaiwan-kadir">
                    <svg className="m-2" width="50px" height="50px" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 382 382" >
                ...
                <a className="no-decoration" target="_blank" rel="noreferrer" href="https://github.com/kobrakai415">
                    <svg className="m-2" width="50px" height="50px" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 50 50" >
                ...
                <a href="mailto:kai.kadir@hotmail.co.uk" target="_blank" rel="noreferrer">
                    <svg className="m-2" width="50px" height="50px" xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512">
                    ...
                    <div className="row pt-5 mx-auto">
                        ...
                        <div className="col-7 pt-3 mx-auto">
                            ...
                            {loading ? <>
                                ...
                                : <input required type="submit" disabled={loading} className="btn btn-info" value="Send Message" />
                            }
                        </div>
                    </div>
                </form>
